...
session_start();
// || $_SESSION['tipo'] != 1
if(!isset($_SESSION['email'], $_SESSION['senha'], $_SESSION['tipo'])) {
...
<head>
	...
	<link rel="stylesheet" href="/aluno/assets/css/atlantis.min.css">
	...
	if(isset($_GET['slug']) && file_exists($_GET['slug'] . '.html')) {
		echo '<link rel="stylesheet" href="/aluno/assets/css/' . $_GET['slug'] . '.css"';
	}
	?>
...
<body>
    <div class="wrapper">
		<div class="main-header">
			<div class="logo-header" data-background-color="blue">
				<a href="/aluno/" class="navbar-brand text-white">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img">
													<img src="/aluno/assets/midia/profile.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
								<div class="avatar-sm">
									<img src="/aluno/assets/midia/profile.jpg" class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="/aluno/assets/midia/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
	...
	<script src="/aluno/assets/js/atlantis.min.js"></script>
	<?php
	if(isset($_GET['slug']) && file_exists($_GET['slug'] . '.html')) {
		echo '<script src="/aluno/assets/js/' . $_GET['slug'] . '.js"></script>';
	}
	?>
</body>
</html>